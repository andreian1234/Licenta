...
public class RecipeDTO {
     ...
     public RecipeDTO(String label, String image, String url, int yield, double calories, double totalWeight, List<String> cuisineType, List<String> mealType, List<String> dishType, List<String> dietLabels, List<String> healthLabels, List<String> cautions, List<String> ingredientLines, List<IngredientDTO> ingredientDTOS, List<DigestDTO> digestDTO, String self) {
          this.label = label;
          this.image = image;
          this.url = url;
          this.yield = yield;
